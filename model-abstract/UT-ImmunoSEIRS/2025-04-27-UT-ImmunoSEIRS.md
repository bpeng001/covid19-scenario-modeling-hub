...
We parameterized the variant characteristics according to best literature estimates on transmissibility, immune escape, and severity. In case of uncertainty, we have used the estimates which provided the most accurate predictions in our previous projections. We consider the decedents (KP.3, XEC, LP.8.1)  of JN.1 variant have 20% chances to escape immunity against infection, hospitalization and death. We fit the initial immunities attained by these variants.
...
We obtain the initial immunities attained by variants at time t=0 from the previous COVID-19 season. The immune escape is modeled as a function such that the immune escape gradually changes at the constant rate for the circulating variant.
...
Infection acquired immunity is modeled. 
...
The calibration period is between October 21, 2024 to April 26, 2025. We did not use the data prior to this period for calibration.  
...
Seasonality inclusion and segregation based on low and high risk groups in addition to being age-stratified. 
